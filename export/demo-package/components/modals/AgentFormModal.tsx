...
import { Agent, LLMConfig, LLMProvider, LLMCapability, HistoryConfig, Tool, OutputConfig, OutputFormat } from '../../types';
...
export const AgentFormModal = ({ onClose, onSave, llmConfigs, existingAgent }: AgentFormModalProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSave({ name, role, systemPrompt, llmProvider, model, capabilities: selectedCapabilities, historyConfig, tools, outputConfig }, existingAgent?.id);
  };
