...
export const RobotPageRouter: React.FC<RobotPageRouterProps> = ({ currentPath, llmConfigs, onNavigate }) => {
  ...
  if (currentPath.startsWith('/com')) {
    return (
      <PlaceholderPage 
        robotName="Com Connections" 
        description="Gestion des APIs et intégrations externes"
      />
    );
  }
  ...
  if (currentPath.startsWith('/phil')) {
    return (
      <PlaceholderPage 
        robotName="Phil Data" 
        description="Transformation et validation des données"
      />
    );
  }
  ...
  if (currentPath.startsWith('/tim')) {
    return (
      <PlaceholderPage 
        robotName="Tim Scheduling" 
        description="Gestion des événements et du timing"
      />
    );
  }
