...
---
**Context** 
You are tasked with creating a comprehensive functional test for a specific use case based on the provided domain logic in the file `documentation/PROTOTYPE_NON_AFFECTATION_VALIDATION.md`. The goal is to ensure that the test accurately reflects real user interactions and validates the business functionality described in the document. 
