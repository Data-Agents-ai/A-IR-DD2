...
// Robot Specialized Icons
export const HardHatIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const FuturisticAIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const DoubleChevronLeftIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const LogoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="120" height="40" viewBox="0 0 120 40" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <defs>
            ...
            <linearGradient id="galactic-text" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" stopColor="#a3b8ff" />
                <stop offset="100%" stopColor="#ffffff" />
            </linearGradient>
        </defs>
        <path d="M20 5 L10 35 L0 35 L10 5 Z" fill="url(#grad1)" />
        <path d="M15 5 L25 35 L35 35 L25 5 Z" fill="url(#grad2)" />

        <rect x="40" y="6" width="75" height="28" rx="4" fill="rgba(30, 41, 59, 0.5)" stroke="rgba(71, 85, 105, 0.7)" />
...
export const EmbeddingIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M4 15h16M4 18h16M4 21h16" />
        <path d="M12 3v10" />
...
export const OcrIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M4 10a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h4" />
        <path d="M20 4a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-4" />
        <path d="M10 20a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-4" />
        <path d="M14 14a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-4" />
        <path d="M7 7h3" />
        <path d="M14 7h3" />
        <path d="M7 17h3" />
    </svg>
...
// =================== NOUVELLES ICÔNES ROBOTS ===================

// Com - Ondes radio (optimisées)
export const AntennaIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
// Bos - Œil de surveillance/monitoring (optimisé)
...
// Phil - Fichier simple (sans doublons)
export const FileAnalysisIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
